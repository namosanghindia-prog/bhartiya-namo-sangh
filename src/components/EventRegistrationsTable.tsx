...
/**
 * Every public registration for the event, searchable. Shared by the admin page
 * and a moderator's dashboard; RLS decides who actually gets rows back, so this
 * component does no permission checks of its own.
 */
export default function EventRegistrationsTable({
  canExport,
  subtitle,
}: {
  /** Admins can download the list; moderators only view it. */
  canExport: boolean;
